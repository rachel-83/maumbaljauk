...
const POSITIVE_ROOTS = [
  // 기쁨·행복
  '기쁘','기뻐','기뻤','기분좋','행복','행복해','행복했','좋아','좋았','좋은','좋겠','좋네','좋다','좋고',
  // 즐거움·신남
  ...
  // 위로·편안
  '다행','편하','편했','홀가분','후련','포근','든든','안심','안도','다행이','개운','시원','상쾌',
  // 희망·긍정
  '희망','용기','의욕','활기','보람','기대','가능','긍정',
  // 관계·화해
  '화해','친해','친하','함께','좋은 친','멋있','귀여','예쁘','예뻐',
  // 기타 긍정
  '따뜻','뭉클','벅차','짜릿','흐뭇','나아졌','좋아졌','풀렸','해결됐','최고','대박','굿','완벽',
]

const NEGATIVE_ROOTS = [
  // 슬픔
  '슬프','슬펐','슬퍼','슬픔','눈물','울었','울어','울었어','울컥','서러','서러웠','슬프고',
  // 힘듦·지침
  '힘들','힘드','힘겨','지치','지쳤','지쳐','피곤','무기력','기운없','녹초',
  // 화·분노·짜증 (슬랭 포함)
  '화나','화났','화가','짜증','짜증나','짜증났','열받','열이나','분하','억울',
  '짜치','빡치','빡쳐','빡침','열나','욱','부글','뚜껑','돌아버','미치겠','어이없',
  // 불안·걱정
